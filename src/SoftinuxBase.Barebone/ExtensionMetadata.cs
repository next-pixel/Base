...
namespace SoftinuxBase.Barebone
{
    public class ExtensionMetadata : IExtensionMetadata
    {
        ...
        public IEnumerable<StyleSheet> StyleSheets => new[]
        {
            ...
            // -- Metro 4
            // new StyleSheet("/node_modules.metro4_dist.css.metro.css", 51),
            new StyleSheet("/node_modules.metro4_dist.css.metro-all.css", 52),
            // new StyleSheet("/node_modules.metro4_dist.css.metro-icons.css", 53),
            // new StyleSheet("/node_modules.metro4_dist.css.metro-colors.css", 54),
        ...
        {
            new Script("/node_modules.jquery.dist.jquery.min.js", 10),
            new Script("/node_modules.jquery_validation.dist.jquery.validate.min.js", 20),
            new Script("/node_modules.jquery_validation_unobtrusive.dist.jquery.validate.unobtrusive.js", 30),
            new Script("/node_modules.js_cookie.src.js.cookie.js", 40),
            new Script("/node_modules.inputmask.dist.inputmask.min.js", 50),

            // -- Roastr
            new Script("/node_modules.toastr.build.toastr.min.js", 60),
            new Script("/node_modules.ionicons.ionicons.js", 61, Script.JsType.NoModule),

            // -- Metro 4
            new Script("/node_modules.metro4_dist.js.metro.js", 70),
            ...
            new Script("/Scripts.barebone.js",  80, Script.JsType.IsModule),
            new Script("/Scripts.barebone_ajax.js",  81, Script.JsType.IsModule),
        };
